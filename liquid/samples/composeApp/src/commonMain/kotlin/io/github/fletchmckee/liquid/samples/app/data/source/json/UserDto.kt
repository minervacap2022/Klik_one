...
fun LiquidGlassPreferences.toDto(): LiquidGlassPreferencesDto = LiquidGlassPreferencesDto(
...
fun LiquidGlassPreferencesDto.toDomain(): LiquidGlassPreferences = LiquidGlassPreferences(
  transparency = transparency,
  frost = frost,
  refraction = refraction,
  curve = curve,
