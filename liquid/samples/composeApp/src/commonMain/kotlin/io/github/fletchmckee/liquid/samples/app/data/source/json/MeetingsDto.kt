...
fun ParticipantDto.toDomain(): Person = Person(
...
fun ActionItemDto.toDomain(): TodoItem = TodoItem(
  id = id,
  text = text,
  isCompleted = isCompleted,
)

fun MeetingMinuteDto.toDomain(): MeetingMinute = MeetingMinute(
  category = category,
  items = items,
)

fun DailyBriefingDto.toDomain(): DailyBriefing = DailyBriefing(
  summary = summary,
