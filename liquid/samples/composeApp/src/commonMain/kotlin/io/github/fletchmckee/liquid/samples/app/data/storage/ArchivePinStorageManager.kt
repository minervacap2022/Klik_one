...
class ArchivePinStorageManager(private val storage: SecureStorage) {
  ...
  fun loadArchivedTaskIds(): Set<String> = loadArchivedIds(ArchivePinStorageKeys.ARCHIVED_TASK_IDS)

  fun saveArchivedMeetingIds(ids: Set<String>) {
    saveArchivedIds(ArchivePinStorageKeys.ARCHIVED_MEETING_IDS, ids)
  }

  fun loadArchivedMeetingIds(): Set<String> = loadArchivedIds(ArchivePinStorageKeys.ARCHIVED_MEETING_IDS)

  fun saveArchivedProjectIds(ids: Set<String>) {
    saveArchivedIds(ArchivePinStorageKeys.ARCHIVED_PROJECT_IDS, ids)
  }

  fun loadArchivedProjectIds(): Set<String> = loadArchivedIds(ArchivePinStorageKeys.ARCHIVED_PROJECT_IDS)

  fun saveArchivedPersonIds(ids: Set<String>) {
    saveArchivedIds(ArchivePinStorageKeys.ARCHIVED_PERSON_IDS, ids)
  }

  fun loadArchivedPersonIds(): Set<String> = loadArchivedIds(ArchivePinStorageKeys.ARCHIVED_PERSON_IDS)

  fun saveArchivedOrganizationIds(ids: Set<String>) {
    saveArchivedIds(ArchivePinStorageKeys.ARCHIVED_ORGANIZATION_IDS, ids)
  }

  fun loadArchivedOrganizationIds(): Set<String> = loadArchivedIds(ArchivePinStorageKeys.ARCHIVED_ORGANIZATION_IDS)
  ...
  fun loadPinnedTaskIds(): Map<String, Long> = loadPinnedIds(ArchivePinStorageKeys.PINNED_TASK_IDS)

  fun savePinnedMeetingIds(ids: Map<String, Long>) {
    savePinnedIds(ArchivePinStorageKeys.PINNED_MEETING_IDS, ids)
  }

  fun loadPinnedMeetingIds(): Map<String, Long> = loadPinnedIds(ArchivePinStorageKeys.PINNED_MEETING_IDS)

  fun savePinnedProjectIds(ids: Map<String, Long>) {
    savePinnedIds(ArchivePinStorageKeys.PINNED_PROJECT_IDS, ids)
  }

  fun loadPinnedProjectIds(): Map<String, Long> = loadPinnedIds(ArchivePinStorageKeys.PINNED_PROJECT_IDS)

  fun savePinnedPersonIds(ids: Map<String, Long>) {
    savePinnedIds(ArchivePinStorageKeys.PINNED_PERSON_IDS, ids)
  }

  fun loadPinnedPersonIds(): Map<String, Long> = loadPinnedIds(ArchivePinStorageKeys.PINNED_PERSON_IDS)

  fun savePinnedOrganizationIds(ids: Map<String, Long>) {
    savePinnedIds(ArchivePinStorageKeys.PINNED_ORGANIZATION_IDS, ids)
  }

  fun loadPinnedOrganizationIds(): Map<String, Long> = loadPinnedIds(ArchivePinStorageKeys.PINNED_ORGANIZATION_IDS)
  ...
  private fun loadArchivedIds(key: String): Set<String> = try {
  ...
  private fun loadPinnedIds(key: String): Map<String, Long> = try {
    val jsonString = storage.getString(key)
    if (jsonString != null) {
