...
class TaskRepositoryImpl(
  ...
  override suspend fun getTasks(): Result<List<TaskMetadata>> = try {
    val tasks = dataSource.getTasks()
  ...
  override suspend fun getTaskById(id: String): Result<TaskMetadata> = try {
  ...
  override suspend fun getTasksByStatus(status: TaskStatus): Result<List<TaskMetadata>> = try {
  ...
  override suspend fun getTasksByPriority(priority: TaskPriority): Result<List<TaskMetadata>> = try {
  ...
  override suspend fun getPinnedTasks(): Result<List<TaskMetadata>> = try {
  ...
  override suspend fun getTaskSummary(): Result<TaskSummary> = try {
  ...
  override suspend fun createTask(task: TaskMetadata): Result<TaskMetadata> = try {
  ...
  override suspend fun updateTask(task: TaskMetadata): Result<TaskMetadata> = try {
  ...
  override suspend fun toggleTaskPin(taskId: String): Result<TaskMetadata> = try {
  ...
  override suspend fun updateTaskStatus(taskId: String, status: TaskStatus): Result<TaskMetadata> = try {
  ...
  override suspend fun getTodoItems(taskId: String): Result<List<TodoItem>> = try {
  ...
  override suspend fun toggleTodoItem(taskId: String, todoId: String): Result<TodoItem> = try {
  ...
  override suspend fun getTasksForMeeting(meetingId: String): Result<List<TaskMetadata>> = try {
  ...
  override suspend fun getTasksForProject(projectId: String): Result<List<TaskMetadata>> = try {
