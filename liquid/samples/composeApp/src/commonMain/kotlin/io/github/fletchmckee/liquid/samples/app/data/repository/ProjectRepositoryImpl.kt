...
class ProjectRepositoryImpl(
    ...
    override suspend fun getProjectsByStatus(status: ProjectStatus): Result<List<Project>> {
        return try {
    ...
    override suspend fun getActiveProjects(): Result<List<Project>> {
        return try {
    ...
    override suspend fun searchProjects(query: String): Result<List<Project>> {
        return try {
    ...
    override suspend fun getProjectsForOrganization(organizationId: String): Result<List<Project>> {
        return try {
    ...
    override suspend fun getProjectsForPerson(personId: String): Result<List<Project>> {
        return try {
    ...
    override suspend fun updateProjectStatus(projectId: String, status: ProjectStatus): Result<Project> {
        return try {
    ...
    override suspend fun updateProjectProgress(projectId: String, progress: Int): Result<Project> {
        return try {
    ...
    override suspend fun getProjectStatistics(): Result<ProjectStatistics> {
        return try {
    ...
    override suspend fun toggleProjectPin(projectId: String): Result<Project> {
        return try {
    ...
    override suspend fun getPinnedProjects(): Result<List<Project>> {
        return try {
