...
object KlikLogger {
    ...
    fun d(tag: String, message: String, throwable: Throwable? = null, labels: Map<String, String>? = null) =
        log(LogLevel.DEBUG, tag, message, throwable, labels)

    fun i(tag: String, message: String, throwable: Throwable? = null, labels: Map<String, String>? = null) =
        log(LogLevel.INFO, tag, message, throwable, labels)

    fun w(tag: String, message: String, throwable: Throwable? = null, labels: Map<String, String>? = null) =
        log(LogLevel.WARN, tag, message, throwable, labels)

    fun e(tag: String, message: String, throwable: Throwable? = null, labels: Map<String, String>? = null) =
        log(LogLevel.ERROR, tag, message, throwable, labels)
    ...
    fun exportLogsAsNdjson(): String {
        return buffer.getAll().joinToString("\n") { entry ->
