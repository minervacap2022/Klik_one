...
object HttpClient {
     ...
     * Automatically adds auth headers and retries on 401 with token refresh.
     */
    suspend fun getUrl(url: String, headers: Map<String, String> = emptyMap()): String? {
        return getUrlWithRetry(url, headers)
    }
     ...
     * Automatically adds auth headers and retries on 401 with token refresh.
     */
    suspend fun postUrl(url: String, body: String, headers: Map<String, String> = emptyMap()): String? {
        return postUrlWithRetry(url, body, headers)
    }
     ...
     */
    private suspend fun getUrlWithRetry(url: String, extraHeaders: Map<String, String>): String? {
        return executeWithRetry("GET", url, extraHeaders)
    }

    /**
     * Internal POST with unified retry
     */
    private suspend fun postUrlWithRetry(url: String, body: String, extraHeaders: Map<String, String>): String? {
        return executeWithRetry("POST", url, extraHeaders, body)
    }

    /**
     * Make a PUT request with unified retry
     */
    suspend fun putUrl(url: String, body: String, headers: Map<String, String> = emptyMap()): String? {
     ...
     */
    suspend fun deleteUrl(url: String, headers: Map<String, String> = emptyMap(), body: String? = null): String? {
        return executeWithRetry("DELETE", url, headers, body)
    }
