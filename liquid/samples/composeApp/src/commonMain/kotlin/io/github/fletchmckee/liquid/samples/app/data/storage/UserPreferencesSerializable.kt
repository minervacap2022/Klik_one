...
data class UserPreferencesSerializable(
  ...
  companion object {
     ...
     */
    fun fromDomain(prefs: UserPreferences): UserPreferencesSerializable = UserPreferencesSerializable(
...
data class LiquidGlassPreferencesSerializable(
  ...
  companion object {
    fun fromDomain(prefs: LiquidGlassPreferences): LiquidGlassPreferencesSerializable = LiquidGlassPreferencesSerializable(
