 ...
 */
fun EntityDimensionScoreDto.toDomain(): DimensionScore = DimensionScore(
  id = id,
...
fun OrganizationDto.toDomain(): io.github.fletchmckee.liquid.samples.app.domain.entity.Organization = io.github.fletchmckee.liquid.samples.app.domain.entity.Organization(
  id = id,
  name = canonical_name ?: "",
  canonicalName = canonical_name ?: "",
  type = type,
