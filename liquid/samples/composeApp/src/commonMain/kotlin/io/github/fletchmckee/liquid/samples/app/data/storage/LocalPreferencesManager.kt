...
class LocalPreferencesManager(private val storage: SecureStorage) {
   ...
   */
  fun savePreferences(preferences: UserPreferences): Boolean = try {
   ...
   */
  fun loadPreferences(): UserPreferences? = try {
   ...
   */
  fun hasPreferences(): Boolean = storage.getString(PreferenceKeys.USER_PREFERENCES) != null
}
