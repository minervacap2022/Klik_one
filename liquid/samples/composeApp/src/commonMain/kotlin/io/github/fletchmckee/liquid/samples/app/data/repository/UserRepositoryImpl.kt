...
class UserRepositoryImpl(
    ...
    override suspend fun updateLiquidGlassPreferences(preferences: LiquidGlassPreferences): Result<LiquidGlassPreferences> {
        return try {
    ...
    override suspend fun updateDeviceStatus(deviceId: String, isConnected: Boolean): Result<Device> {
        return try {
    ...
    override suspend fun updateBackgroundIndex(index: Int): Result<UserPreferences> {
        return try {
