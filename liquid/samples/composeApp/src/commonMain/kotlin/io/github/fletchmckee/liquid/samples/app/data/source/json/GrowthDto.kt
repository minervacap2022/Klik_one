...
fun AchievementsDto.toDomain(): Achievements {
    return Achievements(
...
fun StreakInfoDto.toDomain(): StreakInfo {
    return StreakInfo(
...
fun GrowthDataPointDto.toDomain(): GrowthDataPoint {
...
fun NetworkGrowthStatsDto.toDomain(): NetworkGrowthStats {
...
fun DimensionScoreDto.toDomain(): io.github.fletchmckee.liquid.samples.app.domain.entity.DimensionScore {
    return io.github.fletchmckee.liquid.samples.app.domain.entity.DimensionScore(
        id = id,
...
fun EngagementStatsDto.toDomain(): EngagementStats {
