...
class FeedbackRepositoryImpl(
  ...
  override suspend fun getFeedback(): Result<List<Feedback>> = try {
    val feedback = dataSource.getFeedback()
  ...
  override suspend fun getFeedbackById(id: String): Result<Feedback> = try {
  ...
  override suspend fun getFeedbackForScreen(screen: String): Result<List<Feedback>> = try {
  ...
  override suspend fun updateFeedback(feedback: Feedback): Result<Feedback> = try {
  ...
  override suspend fun deleteFeedback(feedbackId: String): Result<Unit> = try {
  ...
  override suspend fun getPendingFeedback(): Result<List<Feedback>> = try {
  ...
  override suspend fun syncFeedback(): Result<Int> = try {
  ...
  override suspend fun getFeedbackStats(): Result<FeedbackStats> = try {
