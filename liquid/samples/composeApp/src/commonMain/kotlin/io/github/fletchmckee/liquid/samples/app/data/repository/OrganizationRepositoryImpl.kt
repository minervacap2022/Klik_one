...
class OrganizationRepositoryImpl(
    ...
    override suspend fun getOrganizationById(id: String): Result<Organization> {
        return try {
    ...
    override suspend fun searchOrganizations(query: String): Result<List<Organization>> {
        return try {
    ...
    override suspend fun getOrganizationsByIndustry(industry: String): Result<List<Organization>> {
        return try {
    ...
    override suspend fun getTopOrganizations(limit: Int): Result<List<Organization>> {
        return try {
    ...
    override suspend fun getOrganizationForPerson(personId: String): Result<Organization?> {
        return try {
    ...
    override suspend fun updateOrganization(organization: Organization): Result<Organization> {
        return try {
    ...
    override suspend fun refreshOrganizations(): Result<Unit> {
        return try {
            refreshOrganizationsInternal()
            Result.Success(Unit)
        } catch (e: Exception) {
    ...
    override suspend fun toggleOrganizationPin(organizationId: String): Result<Organization> {
        return try {
    ...
    override suspend fun getPinnedOrganizations(): Result<List<Organization>> {
        return try {
