...
class InMemoryFeedbackDataSource {
    ...
    fun getFeedbackForScreen(screen: String): List<Feedback> {
        return feedbackList.filter { it.screen == screen }
    }
    ...
    fun deleteFeedback(feedbackId: String): Boolean {
        return feedbackList.removeAll { it.id == feedbackId }
    }
