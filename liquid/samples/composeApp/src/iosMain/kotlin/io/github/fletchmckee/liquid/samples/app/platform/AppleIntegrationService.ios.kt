...
actual object AppleIntegrationService {
     ...
     */
    actual fun checkCalendarPermission(): ApplePermissionStatus {
     ...
     */
    actual fun checkRemindersPermission(): ApplePermissionStatus {
        return mapAuthorizationStatus(
     ...
     */
    private fun mapAuthorizationStatus(status: EKAuthorizationStatus): ApplePermissionStatus {
        return when (status) {
